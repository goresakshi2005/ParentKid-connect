...
function TeenDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <h1 className="text-4xl font-extrabold mb-10 dark:text-white tracking-tight">Your Growth <span className="dark:text-pink-500">Dashboard</span></h1>

      {showAssessmentPrompt && (
        <div className="bg-blue-50 dark:bg-pink-500/10 border-l-4 border-blue-600 dark:border-pink-500 p-8 mb-10 rounded-2xl shadow-sm">
          <h3 className="text-xl font-bold mb-3 dark:text-white">Unlock Your Growth Insights</h3>
          <p className="text-gray-700 dark:text-slate-300 mb-6 text-lg">
            Take a quick self-assessment to get personalized insights and track your growth journey.
          </p>
          <div className="flex gap-4">
            <button className="px-6 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 dark:bg-pink-600 dark:hover:bg-pink-700 font-bold shadow-lg dark:shadow-pink-500/20 transition-all">
              Start Assessment
            </button>
            <button
              onClick={() => setShowAssessmentPrompt(false)}
              className="px-6 py-2.5 text-blue-600 border border-blue-600 rounded-xl hover:bg-blue-50 dark:text-pink-400 dark:border-pink-500 hover:dark:bg-pink-500/10 transition-all font-semibold"
            >
              Maybe Later
            </button>
          </div>
      ...
      {latestResult ? (
            ...
            <div className="mt-8">
              ...
              {canAccessInsights() ? (
                ...
                <div className="bg-gray-100 dark:bg-slate-800 p-10 rounded-2xl text-center border dark:border-slate-700">
                  ...
                  <button className="px-8 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 dark:bg-pink-600 dark:hover:bg-pink-700 shadow-lg dark:shadow-pink-500/20 transition-all">Upgrade to Growth</button>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="card dark:bg-slate-900 border dark:border-slate-800 p-16 text-center shadow-lg flex flex-col items-center justify-center">
          ...
          <button className="px-10 py-4 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 dark:bg-pink-600 dark:hover:bg-pink-700 shadow-xl dark:shadow-pink-500/30 transition-all transform hover:scale-105 active:scale-95">
