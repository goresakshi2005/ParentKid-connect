  ...
  return (
    <div className="max-w-md mx-auto py-20 px-4">
      <div className="bg-white p-8 rounded-lg shadow">
        <h2 className="text-2xl font-bold mb-6">Teen Signup</h2>
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Invite Code (from parent)</label>
            <input
              type="text"
            ...
            {formik.touched.inviteCode && formik.errors.inviteCode && (
              <p className="text-red-500 text-sm">{formik.errors.inviteCode}</p>
            )}
          </div>
        ...
        <p className="text-center text-sm mt-4">
          ...
          <Link to="/login/teen" className="text-blue-600 hover:underline">
            Login here
          </Link>
        </p>
      </div>
